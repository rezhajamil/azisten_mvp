          ...
          @foreach ($kosSearches as $key=>$data)
              <tr>
                ...
                @switch($data->status_id)
                    @case(1)
                      <td><span class="badge bg-warning">{{ $data->status->name }}</span></td>
                      @break
                    @case(2)
                      <td><span class="badge bg-primary">{{ $data->status->name }}</span></td>
                        @break
                    @case(3)
                      <td><span class="badge bg-success">{{ $data->status->name }}</span></td>
                        @break
                    @case(4)
                      <td><span class="badge bg-grey1">{{ $data->status->name }}</span></td>
                        @break
                    @case(5)
                      <td><span class="badge bg-danger">{{ $data->status->name }}</span></td>
                        @break
                    @default
